...
<body>
    ...
    <nav class="navbar">
        <div class="header-company">
            <img src="../Assets/images/Shipsmart header icon.png" alt="ShipSmart Logo" class="footer-logo">
            <h1>ShipSmart</h1>
        </div>
        <ul class="nav-links">
        ...
        <div class="row footer-content">
            ...
            <div class="footer-taskbar">
                <div class="footer-company">
                    <img src="../Assets/images/Shipsmart footer icon.png" alt="ShipSma Logo" class="footer-logo">
                    <span>ShipSmart</span>
                </div>
                <ul class="nav">
