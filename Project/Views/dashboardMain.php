...
<body>
  <?php include '../includes/navbar.php'; ?> <!-- Include the reusable navbar -->
  ...
  <main>
    ...
    <div class="dashboard">
      ...
      <div class="quick-actions">
        <h3>Quick Actions</h3>
        <ul>
          <li><a href="/ShipmentApp/pages/schedulePickup.php">Schedule Pickup</a></li>
          <li><a href="/ShipmentApp/pages/trackShipment.php">Track Shipment</a></li>
          <li><a href="/ShipmentApp/pages/manageBookings.php">Manage Bookings</a></li>
        </ul>
      </div>
    </div>
  </main>
