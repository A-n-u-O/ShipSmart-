document.addEventListener("DOMContentLoaded", () => {
  ...
  if (pickupDetails) {
    ...
    document.getElementById("confirm-courier").innerHTML = `
      <img src="${pickupDetails.logo}" alt="${pickupDetails.company_name} logo" width="50">
      ${pickupDetails.courier_name}
    `;
    document.getElementById("confirm-company").textContent = `Company: ${pickupDetails.company_name || 'Not available'}`;
  } else {
