...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $error_messages['db'] = 'Error saving booking. Please try again.';
    }
}
?>
...
<body>
    ...
    <main class="schedule-pickup-form">
        ...
        <form action="schedulePickup.php" method="POST">
            ...
            <button type="submit" id="confirm-pickup-btn" class="submit-btn">Schedule Pickup</button>
        </form>
    </main>
</body>
</html>
