...
<body>
  ...
  <div id="results">
    ...
    <p><strong>Shipping Port:</strong> <?= htmlspecialchars($port_details['port_name']) ?> (<?= htmlspecialchars($port_details['location']) ?>)</p>
  </div>
